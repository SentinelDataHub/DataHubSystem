...
public class DefaultDataStore implements DataStore
{
   ...
   {
      productService.systemDeleteProduct (p_id);
   }

   @Override
   public void addProduct(URL path, User owner, List<Collection> collections,
      String origin, Scanner scanner, FileScannerWrapper wrapper)
   {
      productService.addProduct(path, owner, collections, origin,
         scanner, wrapper);
   }
}
