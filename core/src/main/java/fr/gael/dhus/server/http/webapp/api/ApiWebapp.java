 ...
 */
package fr.gael.dhus.server.http.webapp.api;
...
@Component
@WebApp(name = "api")
public class ApiWebapp extends WebApplication
{
   
   @Override
   public void configure(String dest_folder) throws IOException
   {
      String configurationFolder = "fr/gael/dhus/server/http/webapp/api";
