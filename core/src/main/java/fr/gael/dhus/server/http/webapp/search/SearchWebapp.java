 ...
 */
package fr.gael.dhus.server.http.webapp.search;
...
@Component
@WebApp(name = "search")
public class SearchWebapp extends WebApplication
{
   
   @Override
   public void configure(String dest_folder) throws IOException
   {
      String configurationFolder = "fr/gael/dhus/server/http/webapp/search";
