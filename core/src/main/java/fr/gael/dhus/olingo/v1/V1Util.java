...
public class V1Util
{
   ...
   private static final Logger LOGGER = Logger.getLogger (V1Util.class);
   ...
   public static String getBasePath ()
   {
      if (URL_BASE == null)
      {
         OlingoWebapp os = ApplicationContextProvider.getBean (
               OlingoWebapp.class);
      ...
      long contentLength, ODataContext context, InputStream stream)
   {
      ...
      if (range != null)
      {
         ...
         if (rangeList.isEmpty ())
         {
            for (String part : range.substring (6).split (","))
            {
                ...
                */
               long start = V1Util.sublong (part, 0, part.indexOf ("-"));
               long end =
                  V1Util.sublong (part, part.indexOf ("-") + 1, part.length ());
      ...
      builder.header ("Expires", asHttpDate (
            System.currentTimeMillis () + V1Util.DEFAULT_EXPIRE_TIME));
