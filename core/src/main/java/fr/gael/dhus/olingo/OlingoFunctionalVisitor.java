 ...
 */
public abstract class OlingoFunctionalVisitor implements ExpressionVisitor
{
    ...
    * {@linkplain ExecutableExpressionTree.Node#createDuoNode(Transformer,
    ...
    */
   @Override
   public abstract Object visitOrder(OrderExpression oe, Object filter, SortOrder sort_order);
