...
public class AdminEvictionController {
     ...
     * @return      Response
     */
    @RequestMapping(value = "/stub/admin/evictions", method= RequestMethod.GET)
     ...
     * @return     Response
     */
    @RequestMapping(value = "/stub/admin/evictions", method= RequestMethod.PUT)
     ...
     * @return      Response
     */
    @RequestMapping(value = "/stub/admin/evictions/products", method= RequestMethod.GET)
