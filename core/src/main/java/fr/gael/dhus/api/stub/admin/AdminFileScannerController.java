...
import fr.gael.dhus.api.stub.stub_share.exceptions.UploadServiceException;
...
public class AdminFileScannerController {
     ...
     * @return
     */
    @RequestMapping(value = "/stub/admin/filescanners", method= RequestMethod.GET)
     ...
     */
    @RequestMapping (value = "/stub/admin/filescanners/count")
    ...
    @RequestMapping(value = "/stub/admin/filescanners", method= RequestMethod.POST)
    public ResponseEntity<?>  create(@RequestBody FileScannerData body)  {
        ...
        try
        {
            ...
            for (Long cId : body.getCollections())
            {
     ...
     * @return     Response
     */
    @RequestMapping(value = "/stub/admin/filescanners/{id}", method= RequestMethod.PUT)
    public ResponseEntity<?>  update (@RequestBody FileScannerData body,
        ...
        try
        {
            ...
            uploadService.updateFileScanner (id, body.getUrl(),body.getUsername(), body.getPassword(), body.getPattern(), collections);
            return new ResponseEntity<>("{\"code\":\"OK\"}", HttpStatus.OK);
        }
        catch (org.springframework.security.access.AccessDeniedException e)
        {
     ...
     * @return      Response
     */
    @RequestMapping(value = "/stub/admin/filescanners/{id}", method= RequestMethod.DELETE)
