...
public class AdminUserController {
	...
	public ResponseEntity<?>  updateUser (@RequestBody UserData userData, @PathVariable(value="userid") Long userid)throws UserServiceException,
			UserServiceMailingException{
	...
	public ResponseEntity<?> deleteUser (@PathVariable(value="userid") Long userid) throws UserServiceMailingException, UserServiceException {
		fr.gael.dhus.service.UserService userService = ApplicationContextProvider
				.getBean (fr.gael.dhus.service.UserService.class);
