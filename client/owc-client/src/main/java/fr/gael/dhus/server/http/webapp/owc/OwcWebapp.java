 ...
 */
package fr.gael.dhus.server.http.webapp.owc;
...
@Component
@WebApp(name = "api/owc")
public class OwcWebapp extends WebApplication
{
   
   @Override
   public void configure(String dest_folder) throws IOException
   {
      String configurationFolder = "fr/gael/dhus/server/http/webapp/owc";
