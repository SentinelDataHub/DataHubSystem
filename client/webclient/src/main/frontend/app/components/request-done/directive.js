...
.directive('requestDone', function($window, $document, ConfigurationService, 
  SearchService, SearchModel) {
  return {
    restrict: 'AE',
    replace: true,
    templateUrl: 'components/request-done/view.html',
    scope: {
      text: "="
    },
    ...
    compile: function(tElem, tAttrs){
      return {
        ...
        post: function(scope, iElem, iAttrs){  
          scope.title = ApplicationService.settings.querytitle;  
