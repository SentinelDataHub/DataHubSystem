 ...
 */
package fr.gael.dhus.server.http.webapp.stub;
...
@Component
@WebApp(name = "api/stub")
public class StubWebapp extends WebApplication
{
   
   @Override
   public void configure(String dest_folder) throws IOException
   {
      String configurationFolder = "fr/gael/dhus/server/http/webapp/stub";
